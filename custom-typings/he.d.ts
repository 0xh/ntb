// 2018-09-08 (Roar) - Was unable to add 'he' from @types/he for some reason,
// so this is manually copied/pasted from the DefinitelyTyped repo.
// Slight modifications have been done to make it work ("declare module"
// instead of "namespace" and "export var encode" instead of "declare var
// encode").
