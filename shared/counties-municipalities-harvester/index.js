...
async function processCountyData(data, temp) {
  ...
  sql = [
    'INSERT INTO county (',
    '  uuid, code, name, name_lower_case, status, data_source, created_at,',
    '  updated_at',
    ')',
    'SELECT',
    '  uuid, code, name, name_lower_case,',
    '  status::enum_county_status, data_source, now(), now()',
...
async function processMunicipalityData(data, counties, temp) {
  ...
  sql = [
    ...
    '  uuid, county_uuid, code, name, name_lower_case, status, data_source,',
    '  created_at, updated_at',
    ')',
    'SELECT',
    '  uuid, county_uuid, code, name, name_lower_case,',
    '  status::enum_municipality_status, data_source, now(), now()',
